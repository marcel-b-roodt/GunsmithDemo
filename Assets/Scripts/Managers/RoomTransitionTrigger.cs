...
public class RoomTransitionTrigger : MonoBehaviour
{
	...
	{
		GlobalReferences.GameManager.PlayerRoomTransitionManager.TransitionToLevel(DestinationID);
	}

	private GameObject GetDetectedPlayer()
	{
		var entities = playerSensor.GetDetectedByTag(Helpers.Tags.Player);
